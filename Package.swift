...
let package = Package(
    ...
    dependencies: [
        .package(url: "https://github.com/YangXianda007/NexaLLama.git", branch: "main")
    ],
    targets: [
        ...
        .target(
            name: "NexaAI",
            dependencies: [
                .product(name: "nexa_bridge", package: "NexaLLama"),
                .product(name: "llama", package: "NexaLLama"),
                .product(name: "common", package: "NexaLLama"),
                .product(name: "mtmd", package: "NexaLLama")
            ],
            path: "Sources",
